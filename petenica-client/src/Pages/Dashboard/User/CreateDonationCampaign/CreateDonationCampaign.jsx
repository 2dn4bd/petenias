...
import { DonationCampain } from '../../../../Schemas/DonationSchemas';
...
const CreateDonationCampaign = () => {
    ...
    const {values, errors, handleChange, touched,resetForm, handleSubmit,  handleBlur, setFieldValue} = useFormik({
        ...
        validationSchema: DonationCampain,
          ...
          try {
            ...
            if(res.data.asset_id){
              const addDonation = {
                ...
                donate_creator_email: user.email,
                pet_name: values.pet_name
              }
              const backendSetApi = await axiosPublic.post('/donatecampaign',addDonation )
              ...
              if(backendSetApi.data.insertedId){
                ...
                Swal.fire({
                  position: "center",
                  icon: "success",
                  title: "Donate Campaign Make Success",
    ...
    return (
        ...
        <div className="max-w-4xl px-4 mx-auto ">
          <div className="p-6 bg-white rounded-md shadow  ">
            <h2 className="mb-6 text-xl font-medium leading-6 text-gray-900 ">Donate Campaign Information
            </h2>
